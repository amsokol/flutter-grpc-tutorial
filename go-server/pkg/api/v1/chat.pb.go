...
func (*Notification) Descriptor() ([]byte, []int) {
	return fileDescriptor_chat_2bf0147ab850a5dd, []int{0}
}
...
func init() { proto.RegisterFile("chat.proto", fileDescriptor_chat_2bf0147ab850a5dd) }

var fileDescriptor_chat_2bf0147ab850a5dd = []byte{
